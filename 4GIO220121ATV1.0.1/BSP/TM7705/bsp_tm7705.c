...
*/
	...
	/* 定义口线置0和置1的宏 */
	#define RESET_0() HAL_GPIO_WritePin(REST_ADC_GPIO_Port, REST_ADC_Pin, GPIO_PIN_RESET);
	#define RESET_1()	HAL_GPIO_WritePin(REST_ADC_GPIO_Port, REST_ADC_Pin, GPIO_PIN_SET);	
	#define DRDY_IS_LOW()	(HAL_GPIO_ReadPin(ADC_STDY_GPIO_Port, ADC_STDY_Pin) == GPIO_PIN_RESET)
